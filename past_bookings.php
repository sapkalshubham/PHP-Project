...
$id = $_SESSION['id'];
$sql = "select * from lim natural join booking where p_id='$id' and e_time<CURRENT_TIME() and date=sysdate() union select * from lim natural join booking where p_id='$id' and date<CURRENT_DATE";
...
echo "
<form action='fellow_past.php' method='post'>
